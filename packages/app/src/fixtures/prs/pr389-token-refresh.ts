import type { CheckRun, CommitInfo, GhUser, Human, IssueComment, PendingComment, PullDetail, PullFile, ReviewComment, ReviewDraft, ReviewSummary, ReviewThread } from '@revu/shared'
