...
| [one-assembler-per-capability.md](./one-assembler-per-capability.md) | Why a capability wired per boot path drifts silently, the assembler that fixes it, and why only a conformance leg driving the assembler proves a boot |
